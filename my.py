...
weapons=['sword','warhammer','shurikens','scythe','spear','katana']
default_health=100
circle_frames=['○',' ○','  ○','    ○','      ○','       ○','        ○','          ○','                ○','                  ○','                           ○']
#weapon damage stats:
sword_damage=30
        ...
        try:
            ...
            while input_option!=1 and input_option!=2 and input_option!=3 and  input_option!=4:
                ...
                if input_option==1:
                    ...
                    time.sleep(1)
                    generate_options(number_of_options=6,option1=f'{weapons[0]} {weapons_ascii_art[0]}',option2=f'{weapons[1]}{weapons_ascii_art[1]}',option3=f'{weapons[2]} {weapons_ascii_art[5]}',option4=f'{weapons[3]} {weapons_ascii_art[3]}',option5=f'{weapons[4]} {weapons_ascii_art[-2]}',option6=f'{weapons[-1]} {weapons_ascii_art[2]}')
                    time.sleep(1)
